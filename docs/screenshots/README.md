...
| **A news article** | An ordinary written post, which can still have chess diagrams dropped into the middle of the text | [Desktop](desktop/05-post-news.png) · [Phone](mobile/05-post-news.png) |
...
| **Fun Stuff** | Another standing page, this one with a puzzle diagram inside the text | [Desktop](desktop/07-page-fun-stuff.png) · [Phone](mobile/07-page-fun-stuff.png) |
| **Contact the club** | How newcomers and parents get in touch. Messages arrive in an inbox on the site as well as by email | [Desktop](desktop/08-contact.png) · [Phone](mobile/08-contact.png) |
...
Only people the club has invited can have an account. There is no public sign-up: someone can only register if a club officer has already added their email address.

| Page | What it is | View |
|---|---|---|
| **Members' login** | Where members sign in | [Desktop](desktop/09-login.png) · [Phone](mobile/09-login.png) |
| **Setting up an account** | What a member sees after following their invitation link, where they choose their own password | [Desktop](desktop/10-register.png) · [Phone](mobile/10-register.png) |
...
| **The same form, with a game pasted in** | **Worth a look.** The moment a game is pasted, the site confirms *"Valid game — 20 moves, 1 annotated, result 1-0"*, fills in both players, the result, the date and the competition by itself, and shows a working board preview | [Desktop](desktop/13b-editor-annotated-game-with-pgn.png) · [Phone](mobile/13b-editor-annotated-game-with-pgn.png) |
| **Setting up a puzzle** | For a single position. Either paste a FEN, or simply drag the pieces onto the board until it looks right | [Desktop](desktop/14-editor-position.png) · [Phone](mobile/14-editor-position.png) |
| **My profile** | Your name as it appears on posts, your ECF details, and your password | [Desktop](desktop/18-member-profile.png) · [Phone](mobile/18-member-profile.png) |
...
| Page | What it is | View |
|---|---|---|
| **Members** | Invite a new member by entering their email and choosing whether they are an ordinary member or an officer. Also where an account is suspended if someone leaves | [Desktop](desktop/15-admin-members.png) · [Phone](mobile/15-admin-members.png) |
| **Enquiries** | Every message from the contact form, kept on the site so nothing is lost to a spam filter | [Desktop](desktop/16-admin-enquiries.png) · [Phone](mobile/16-admin-enquiries.png) |
| **Pages** | Edit the standing pages — Fixtures, Teams, Coaching, Juniors and so on — and decide which appear in the menu at the top | [Desktop](desktop/17-admin-pages.png) · [Phone](mobile/17-admin-pages.png) |
...
- Are the club night details, venue and postcode correct?
- Are the standing pages the right ones, and is anything out of date?
